...
const translations: Record<string, string> = {
  ...
  "登录": "Login",
  "登录中...": "Logging in...",
  "钉钉登录中...": "Signing in with DingTalk...",
  "钉钉自动登录失败，请使用账号密码登录": "DingTalk sign-in failed; please log in with username and password",
  "钉钉UserID（免登绑定）": "DingTalk UserID (SSO binding)",
  "钉钉绑定": "DingTalk",
  "已绑定": "Linked",
  "退出登录": "Log out",
  "菜单": "Menu",
  ...
  "汇总报表": "Summary Report",
  "水电房费": "Utilities & Rent",
  "水电网气房费": "Utilities & Rent Payments",
  "缴费类型": "Fee Type",
  "缴费日期": "Due Date",
  "距到期": "Due In",
  "金额": "Amount",
  ...
  "钉钉提醒设置": "DingTalk Reminder Settings",
  "新增缴费项": "Add Payment Item",
  "保存缴费项": "Save Payment Item",
  "搜索缴费记录": "Search payment records",
  "发送测试消息": "Send Test Message",
  "是否需要提醒": "Needs Reminder",
  "需要提醒（前 3 天早上 9 点）": "Remind (9 AM, 3 days ahead)",
  "不提醒": "No reminder",
  "待提醒": "Reminder pending",
  "接收缴费钉钉提醒": "Receive Bill Reminders",
  "缴费提醒": "Bill Reminders",
  "接收": "Receiving",
  "不接收": "Not receiving",
  "未提醒": "Not reminded",
  ...
  "保存账户": "Save Account",
  "收起表单": "Hide Form",
  "供应商/公司": "Provider/Company",
  "供应商": "Provider",
  "账号/户号": "Account No.",
  "登录用户名": "Login Username",
  "登录密码": "Login Password",
  "缴费网址": "Payment Website",
  "显示": "Show",
  "隐藏": "Hide",
  "打开": "Open",
  "还没有账户记录": "No account records yet",
